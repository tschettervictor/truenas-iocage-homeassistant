...
### Execution
Once you've downloaded the script and prepared the configuration file, run this script (`script homeassistant.log ./homeassistant-jail.sh`).
...
By default the configuration.yaml file will be copied automatically if you dont choose "n" at the prompt.
Only choose "n" if it is a reinstall, or you have your own file configured.

Once the script is finished, you will need to wait 5-10 minutes for setup to complete within homeassistant itself.
...
- The configuration.yaml file is located at `/home/homeassistant/config`
